...
public class UserNameRecognizer {
	 ...
	 * 
	 * <p>
	 * Copyright: Lynn Robert Carter, Chase Goldberg © 2024-2025
	 * </p>
	 * 
	 ...
	 * @version 1.02 2025-01-24 Changed username requirements. Now you must start
	 *          with a letter. Also periods, underscores, and minus signs can be
	 *          used as long as they are directly followed by a letter
	 * 
	 */
	...
	// I don't know how to correctly edit the copyright, so I left it alone
	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 1:
				...
				// 2: a period, underscore, minus sign that transitions to state 2
				...
				// period, underscore, minus sign-> State 2
		...
		case 1:
			...
			if (userNameSize < 4) {
				...
				userNameRecognizerErrorMessage += "    A UserName character may only contain the following:\nA-Z\na-z\n0-9\nperiod(.)\nunderscore(_)\nminus sign(-)\n";
				return userNameRecognizerErrorMessage;
			} else {
				// UserName is valid
		...
		case 2:
			...
			userNameRecognizerErrorMessage += "    A UserName character after a period, underscore, or minus sign must be A-Z, a-z, 0-9.\n";
			return userNameRecognizerErrorMessage;
